...
const seoKeywords = {
  en: {
    home: 'medical tourism, healthcare, hospitals, doctors, heart surgery, cancer treatment, Apollo Hospitals, medical treatment, health tourism, cardiac surgery, orthopedic surgery, cosmetic surgery, dental treatment, eye surgery, fertility treatment',
    treatments: 'heart bypass surgery, knee replacement, cosmetic surgery, dental implants, LASIK eye surgery, IVF treatment, cancer treatment, orthopedic surgery, medical procedures, surgical treatments',
    hospitals: 'JCI accredited hospitals, Apollo Hospitals, Bumrungrad Hospital, Mount Elizabeth Hospital, Acibadem Hospital, top hospitals, best medical facilities, international hospitals',
    about: 'about Apollo Partners, medical tourism company, healthcare services, patient care, medical facilitators',
    blog: 'medical tourism blog, healthcare articles, treatment guides, patient stories, medical insights'
  },
  fr: {
    home: 'tourisme médical, soins de santé, hôpitaux, médecins, chirurgie cardiaque, traitement du cancer, Hôpitaux Apollo, traitement médical, tourisme de santé, chirurgie cardiaque, chirurgie orthopédique, chirurgie esthétique, traitement dentaire, chirurgie oculaire, traitement de fertilité',
    treatments: 'pontage coronarien, remplacement du genou, chirurgie esthétique, implants dentaires, chirurgie oculaire LASIK, traitement FIV, traitement du cancer, chirurgie orthopédique, procédures médicales, traitements chirurgicaux',
    hospitals: 'hôpitaux accrédités JCI, Hôpitaux Apollo, Hôpital Bumrungrad, Hôpital Mount Elizabeth, Hôpital Acibadem, meilleurs hôpitaux, meilleures installations médicales, hôpitaux internationaux',
    about: 'à propos d\'Apollo Partners, société de tourisme médical, services de santé, soins aux patients, facilitateurs médicaux',
    blog: 'blog sur le tourisme médical, articles sur la santé, guides de traitement, histoires de patients, informations médicales'
  }
};
...
const translations = {
  en: {
    ...
    // SEO Meta
    'siteTitle': 'Apollo Partners - World Class Healthcare & Medical Tourism',
    'siteDescription': 'Premium medical tourism services with top JCI accredited hospitals. Save up to 80% on cardiac, cancer, orthopedic treatments with Apollo Partners.'
  },
  fr: {
    // ... (keep the existing French translations)
    // SEO Meta
    'siteTitle': 'Apollo Partners - Soins de Santé de Classe Mondiale et Tourisme Médical',
    'siteDescription': 'Services premium de tourisme médical avec les meilleurs hôpitaux accrédités JCI. Économisez jusqu\'à 80% sur les traitements cardiaques, cancéreux et orthopédiques.'
  }
};
...
export const LanguageProvider: React.FC<LanguageProviderProps> = ({ children }) => {
  ...
  const getSEOKeywords = (page: string = 'home'): string => {
    return seoKeywords[language][page] || seoKeywords[language]['home'];
  };
