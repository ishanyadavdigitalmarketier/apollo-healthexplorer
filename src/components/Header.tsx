      ...
      <nav className="container mx-auto px-4 py-4">
        <div className="flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <a href="/treatments" className={navLinkClass('/treatments')}>Treatments</a>
            <a href="/hospitals" className={navLinkClass('/hospitals')}>Hospitals</a>
            <a href="/doctors" className={navLinkClass('/doctors')}>Doctors</a>
            <a href="/about" className={navLinkClass('/about')}>About</a>
            <a href="/blog" className={navLinkClass('/blog')}>Blog</a>
            <a href="/contact.html" className={navLinkClass('/contact.html')}>Contact</a>
          </div>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-4 pb-4 space-y-4">
            ...
            <a href="/treatments" className={mobileNavLinkClass('/treatments')}>Treatments</a>
            <a href="/hospitals" className={mobileNavLinkClass('/hospitals')}>Hospitals</a>
            <a href="/doctors" className={mobileNavLinkClass('/doctors')}>Doctors</a>
            <a href="/about" className={mobileNavLinkClass('/about')}>About</a>
            <a href="/blog" className={mobileNavLinkClass('/blog')}>Blog</a>
            <a href="/contact.html" className={mobileNavLinkClass('/contact.html')}>Contact</a>
            <div className="flex gap-3 mt-4">
              <Button variant="outline" size="sm" className="border-primary text-primary">
                Get Quote
              </Button>
