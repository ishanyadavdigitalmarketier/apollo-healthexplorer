...
// BlogSection.tsx - Enhanced responsiveness for all devices
// import { Link } from 'react-router-dom';
// import { Button } from '@/components/ui/button';
// import { Card, CardContent, CardHeader } from '@/components/ui/card';
// import { Badge } from '@/components/ui/badge';
...
//           <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold mb-4">Health & Medical Tourism Insights</h2>
...
//               key={index} 
//               variant={index === 0 ? "default" : "secondary"}
//               className={`cursor-pointer text-xs sm:text-sm px-3 py-1 ${index === 0 ? 'bg-primary text-primary-foreground' : 'hover:bg-primary hover:text-primary-foreground'} transition-colors`}
//             >
//               {category}
//             </Badge>
//           ))}
...
//         {/* Featured Article */}
//         <Card className="mb-8 sm:mb-12 border-0 shadow-lg bg-white">
//           <CardContent className="p-4 sm:p-6 lg:p-8">
//             <div className="flex flex-col sm:flex-row items-start gap-4 sm:gap-6">
//               <div className="text-3xl sm:text-4xl flex-shrink-0">{featuredArticle.icon}</div>
//               <div className="flex-1 min-w-0">
//                 <Badge className="mb-3 sm:mb-4 bg-accent text-accent-foreground text-xs sm:text-sm">
//                   {featuredArticle.category}
//                 </Badge>
//                 <h3 className="text-xl sm:text-2xl font-bold mb-3 sm:mb-4 line-clamp-2">{featuredArticle.title}</h3>
//                 <p className="text-muted-foreground mb-4 sm:mb-6 leading-relaxed text-sm sm:text-base line-clamp-3">
//                   {featuredArticle.description}
//                 </p>
//                 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
//                   <div className="flex flex-wrap items-center gap-3 sm:gap-4 text-xs sm:text-sm text-muted-foreground w-full sm:w-auto">
//                     <span className="font-medium">{featuredArticle.author}</span>
//                     <span>{featuredArticle.date}</span>
//                     <div className="flex items-center gap-1">
...
//                     </div>
//                   </div>
//                   <Button asChild variant="link" className="p-0 h-auto text-xs sm:text-sm w-full sm:w-auto">
//                     <Link to="/article">Read Full Article</Link>
//                   </Button>
//                 </div>
//               </div>
...
//                   <div className="text-xl sm:text-2xl">{article.icon}</div>
//                   <div className="flex items-center gap-1 text-xs sm:text-sm text-muted-foreground">
//                     <Eye className="w-3 h-3 sm:w-4 sm:h-4" />
//                     <span>{article.views}</span>
//                   </div>
//                 </div>
//                 <Badge variant="outline" className="w-fit mb-2 sm:mb-3 text-xs">
//                   {article.category}
//                 </Badge>
//                 <h3 className="text-base sm:text-lg font-bold mb-2 sm:mb-3 group-hover:text-primary transition-colors line-clamp-2">
//                   {article.title}
//                 </h3>
//               </CardHeader>
              
//               <CardContent className="p-4">
//                 <p className="text-muted-foreground text-xs sm:text-sm mb-4 sm:mb-6 leading-relaxed line-clamp-3">
//                   {article.description}
//                 </p>
                
//                 <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between text-xs text-muted-foreground mb-4 sm:mb-0 gap-2">
//                   <span className="font-medium">{article.author}</span>
//                   <div className="flex items-center gap-1">
//                     <Clock className="w-3 h-3" />
//                     <span>{article.readTime}</span>
