...
// // HospitalSection.tsx - Enhanced responsiveness for mobile and all devices
// import { Link } from 'react-router-dom';
// import { Button } from '@/components/ui/button';
// import { Card, CardContent, CardHeader } from '@/components/ui/card';
// import { Badge } from '@/components/ui/badge';
...
//           <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">Top-Rated Partner Hospitals</h2>
...
//           {countries.map((country, index) => (
//             <div key={index} className="text-center group cursor-pointer">
//               <div className="bg-white rounded-lg p-3 sm:p-4 sm:p-6 shadow-md hover:shadow-lg transition-shadow border">
...
//                       <h3 className="text-lg sm:text-xl font-bold mb-1">{hospital.name}</h3>
...
//                     <span className="text-sm sm:text-base text-muted-foreground truncate">{hospital.location}</span>
//                   </div>
...
//                       <span className="text-xs sm:text-sm text-muted-foreground">({hospital.reviews.toLocaleString()} reviews)</span>
//                     </div>
//                   </div>
