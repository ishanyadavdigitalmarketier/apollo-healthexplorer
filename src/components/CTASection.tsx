...
// CTASection.tsx - Enhanced responsiveness for mobile and all devices
// import { Button } from '@/components/ui/button';
// import { Card, CardContent } from '@/components/ui/card';
// import { Phone, MessageCircle, Mail, Shield, Users, Clock, Link as LucideLink } from 'lucide-react';
// import { Link } from 'react-router-dom';
...
//                 <p className="text-sm sm:text-base text-muted-foreground mb-3 sm:mb-4">{method.description}</p>
...
//             <div className="grid grid-cols-2 md:grid-cols-4 gap-4 sm:gap-6 sm:mb-8 mb-6">
//               {finalStats.map((stat, index) => (
//                 <div key={index} className="text-center">
