    ...
    <footer className="w-full bg-background border-t mt-6 sm:mt-8 lg:mt-12">
          ...
          <div className="lg:col-span-1 mb-6 sm:mb-0">
            <Link to="/" className="flex items-center gap-2 sm:gap-3 mb-4">
              ...
              <div className="min-w-0">
                <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary truncate">Apollo Partners</h3>
            ...
            <div className="flex space-x-2 sm:space-x-3 flex-wrap gap-2">
              <a href="https://facebook.com" target="_blank" rel="noopener noreferrer" aria-label="Facebook" className="p-2 hover:bg-muted rounded-md transition-colors">
                <Facebook className="w-4 h-4 sm:w-5 sm:h-5 text-primary hover:text-primary/80 flex-shrink-0" />
              </a>
              <a href="https://twitter.com" target="_blank" rel="noopener noreferrer" aria-label="Twitter" className="p-2 hover:bg-muted rounded-md transition-colors">
                <Twitter className="w-4 h-4 sm:w-5 sm:h-5 text-primary hover:text-primary/80 flex-shrink-0" />
              </a>
              <a href="https://instagram.com" target="_blank" rel="noopener noreferrer" aria-label="Instagram" className="p-2 hover:bg-muted rounded-md transition-colors">
                <Instagram className="w-4 h-4 sm:w-5 sm:h-5 text-primary hover:text-primary/80 flex-shrink-0" />
              </a>
              <a href="https://linkedin.com" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn" className="p-2 hover:bg-muted rounded-md transition-colors">
            ...
            <ul className="space-y-3 text-xs sm:text-sm text-muted-foreground">
              ...
              <li className="flex flex-col sm:flex-row sm:items-center gap-2">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 flex-1 min-w-0">
                  ...
                  <span className="text-xs sm:text-sm break-all">Info@apolopartners.com</span>
                </div>
                <Button 
                  asChild 
                  size="sm" 
      ...
      <div className="border-t bg-muted/50">
        <div className="container mx-auto px-4 sm:px-6 py-2 sm:py-3 lg:py-4 text-center text-xs sm:text-sm text-muted-foreground">
          <p className="leading-relaxed">&copy; 2025 Apollo Partners. All rights reserved. | Designed for Healthcare Excellence.</p>
        </div>
      </div>
    </footer>
  );
...
//               <div className="min-w-0">
//                 <h3 className="text-base sm:text-lg lg:text-xl font-bold text-primary truncate">Apollo Partners</h3>
//                 <p className="text-xs sm:text-sm text-muted-foreground">{t('healthcareExcellence')}</p>
//               </div>
//             </Link>
//             <p className="text-xs sm:text-sm text-muted-foreground mb-4 leading-relaxed">
...
//           {/* Navigation Links */}
//           <div className="mb-6 sm:mb-0">
//             <h4 className="text-xs sm:text-sm font-semibold text-foreground mb-3 sm:mb-4">{t('quickLinks')}</h4>
//             <ul className="space-y-2 text-xs sm:text-sm text-muted-foreground">
//               <li><Link to="/" className="hover:text-primary transition-colors block py-1">{t('home')}</Link></li>
//               <li><Link to="/hospitals" className="hover:text-primary transition-colors block py-1">{t('hospitals')}</Link></li>
//               <li><Link to="/about" className="hover:text-primary transition-colors block py-1">{t('about')}</Link></li>
//               <li><Link to="/contact" className="hover:text-primary transition-colors block py-1">{t('contact')}</Link></li>
//             </ul>
//           </div>

//           {/* Contact Info */}
//           <div className="sm:col-span-2 lg:col-span-1 mb-6 sm:mb-0">
//             <h4 className="text-xs sm:text-sm font-semibold text-foreground mb-3 sm:mb-4">{t('contactUs')}</h4>
//             <ul className="space-y-3 text-xs sm:text-sm text-muted-foreground">
//               <li className="flex flex-col sm:flex-row sm:items-center gap-2">
//                 <Phone className="w-3.5 h-3.5 sm:w-4 sm:h-4 flex-shrink-0 text-primary" />
//                 <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-2 flex-1 min-w-0">
//                   <a href="tel:+911066502502" className="font-medium hover:text-primary transition-colors text-xs sm:text-sm truncate">{t('callNow')}</a>
...
//                   className="mt-2 sm:mt-0 bg-primary hover:bg-primary/90 text-primary-foreground text-xs w-full sm:w-auto whitespace-nowrap"
//                 >
//                   <a href="tel:+911066502502">{t('callNow')}</a>
//                 </Button>
//               </li>
//               {/* Email and Map sections with translations */}
//             </ul>
//           </div>

//           {/* Newsletter Signup */}
//           <div className="sm:col-span-2 lg:col-span-1 mb-6 sm:mb-0">
//             <h4 className="text-xs sm:text-sm font-semibold text-foreground mb-3 sm:mb-4">{t('stayUpdated')}</h4>
//             <p className="text-xs sm:text-sm text-muted-foreground mb-3 sm:mb-4 leading-relaxed">
...
//       <div className="border-t bg-muted/50">
//         <div className="container mx-auto px-4 sm:px-6 py-2 sm:py-3 lg:py-4 text-center text-xs sm:text-sm text-muted-foreground">
//           <p className="leading-relaxed">&copy; 2025 Apollo Partners. {t('allRightsReserved')} | {t('designedForHealthcareExcellence')}</p>
//         </div>
//       </div>
//     </footer>
//   );
