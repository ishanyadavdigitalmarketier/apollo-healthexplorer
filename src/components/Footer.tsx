    ...
    <footer className="w-full bg-background border-t mt-8 sm:mt-12">
      ...
      <div className="container mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8">
          {/* Company Info */}
          <div className="md:col-span-2 lg:col-span-1 mb-6 sm:mb-0">
          ...
          <div className="md:col-span-2 lg:col-span-1 mb-6 sm:mb-0">
            ...
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                ...
                className="flex-1 px-3 py-2.5 border border-input rounded-md bg-background text-foreground focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 text-xs sm:text-sm min-h-[44px]"
              />
              <Button 
                size="sm" 
